...
//
// The Data class is linked to serve as an object to 
...
// Every derived class must override inser and show.
class Node {
...
// We'll see how to make this more genral when 
// we cover templates.
...
int main() {
    ...
    ll.showAll();
    cout << "\n";
    cout << "You entered: " <<  valtwo - 1 << " numbers\n";
